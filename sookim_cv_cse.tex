...
Development and Maintenance of Official Account Messaging APIs\\
Development of the Safety Check Message Transmission System in the event of a disaster\\
Multiple microservice server maintenance\\
Tech Stack: Java, Kotlin, Scala, Spring ecosystem, Armeria, Monix, CentralDogma, Envoy, Grafana, Prometheus, Sentry, Ansible, HBase, Redis, Cassandra, MySQL
}
